...
const Footer = () => {
  return (
    <footer className="bg-black text-white p-10">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div>
            ...
            <p className="hover:underline cursor-pointer">About NASA</p>
            <p className="hover:underline cursor-pointer">NASA en Español</p>
          </div>
        </div>
      ...
      {/* Bottom Links */}
      <div className="container mx-auto mt-8 border-t border-gray-700 pt-4 grid grid-cols-2 md:grid-cols-4 text-sm gap-4 text-gray-400">
